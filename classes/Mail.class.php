<?php
	...
	class Mail{
		...
		public $opt,$mailer;
		public $email = 'EMAIL';      	//e-mail do servidor!       
		public $senha = 'SENHA';   		//senha do servidor !
		...
		public function __construct(Array $parametros){
			...
			$this->mailer->IsSMTP();
			$this->mailer->Host = 'SERVIDOR SMTP HOSPEDAGEM'; //SERVIDOR SMTP DA HOSPEDAGEM
			...
			$this->mailer->Subject = 'Nova mensagem do site!';  // Assunto recebido no email 
